      ...
      <div className="dash-panel" style={{ maxWidth: 600, margin: '0 auto' }}>
        ...
        {step === 2 && (
          <>
            ...
            <p style={{ color: '#8892b0', marginBottom: '1rem' }}>
              Store "<strong style={{ color: '#ccd6f6' }}>{name}</strong>" will be created with auto-generated staff accounts.
            </p>
        ...
        {step === 3 && result && (
          <>
            ...
            <h3 style={{ color: '#ccd6f6', margin: '1.5rem 0 0.8rem' }}>Staff Credentials</h3>
